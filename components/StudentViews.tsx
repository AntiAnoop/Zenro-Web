...
import { Play, Calendar, BookOpen, Video, FileCheck, Loader2, Monitor, ChevronLeft, ChevronRight, User as UserIcon, Radio, FileText, CreditCard } from 'lucide-react';
        ...
        <div className="lg:col-span-2 bg-white rounded-[40px] p-10 border border-gray-100 relative overflow-hidden flex flex-col justify-center shadow-xl shadow-slate-200/50">
          <div className="relative z-10">
            ...
            <div className="flex gap-4">
                ...
                <Link to="/student/courses" className="bg-gray-50 text-slate-800 font-black text-[10px] uppercase tracking-widest px-8 py-4 rounded-2xl hover:bg-gray-100 transition">Study Materials</Link>
            </div>
          </div>
        </div>
...
export const StudentCoursesPage = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            {loading ? <div className="p-20 text-center"><Loader2 className="animate-spin mx-auto text-zenro-red opacity-20"/></div> : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {courses.length === 0 && <div className="col-span-full py-20 text-center text-gray-300 font-bold italic">No courses assigned to your batch yet.</div>}
                </div>
            )}
        </div>
    );
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            {loading ? <div className="p-20 text-center"><Loader2 className="animate-spin mx-auto text-zenro-red opacity-20"/></div> : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {tests.length === 0 && <div className="col-span-full py-20 text-center text-gray-300 font-bold italic">No active exams scheduled for your batch.</div>}
                </div>
            )}
        </div>
    );
...
export const StudentAssignmentsPage = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
             ...
             {loading ? <div className="p-20 text-center"><Loader2 className="animate-spin mx-auto text-zenro-blue opacity-20"/></div> : (
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                     {assignments.map(a => (
                     ...
                     {assignments.length === 0 && <div className="col-span-full py-20 text-center text-gray-300 font-bold italic">You are all caught up! No pending assignments.</div>}
                 </div>
             )}
        </div>
    );
